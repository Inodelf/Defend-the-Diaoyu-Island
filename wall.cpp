/*This source code copyrightedby Lazy Foo' Productions (2004-2013)
...
SDL_Surface *load_image( std::string filename )
{
  ...
  //The optimized surfaces that will be used
...
bool load_files()
{
  ...
  square = load_image( "libpic/square.bmp" );
...
void Square::handle_input()
{
  ...
  if( event.type == SDL_KEYDOWN )
  {
    ...
    {
    case SDLK_UP: yVel -= SQUARE_HEIGHT / 2;
      break;
    case SDLK_DOWN: yVel += SQUARE_HEIGHT / 2;
      break;
    case SDLK_LEFT: xVel -= SQUARE_WIDTH / 2;
      break;
    case SDLK_RIGHT: xVel += SQUARE_WIDTH / 2;
      break;
    }
  }
...
int Timer::get_ticks()
{
  ...
  if( started == true )
  {
    ...
    {
      //Return the current time minus the start timi
