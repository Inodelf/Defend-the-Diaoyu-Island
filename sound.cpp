...
bool load_files()
{
  ...
  //Open the font
  font = TTF_OpenFont( "fonts/simsun.ttf", 30 );
  ...
  scratch = Mix_LoadWAV( "msg.wav" );
  high = Mix_LoadWAV( "ring.wav" );
  med = Mix_LoadWAV( "call.wav" );
  low = Mix_LoadWAV( "Global.wav" );
